                    ...
                    <div class="mt-6 text-gray-500">
                        <form action="{{ route('form-cuti-add') }}" method="POST">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="form-control mb-4">
                                        ...
                                        <input type="text" placeholder="Nama" id="nama" name="nama" required
                                            maxlength="100" class="input input-bordered w-full">
                                    </div>
                                    ...
                                    <div class="form-control mb-4">
                                        ...
                                        <input type="text" placeholder="Jabatan" id="jabatan" name="jabatan" required
                                            maxlength="100" class="input input-bordered w-full">
                                    </div>
                                    ...
                                    <div class="form-control mb-4">
                                        ...
                                        <input type="number" placeholder="Masa Kerja" id="masa_kerja" name="masa_kerja"
                                            required maxlength="2" class="input input-bordered w-full"
                                ...
                                <div class="">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div class="form-control w-full mb-4">
                                            ...
                                            <select name="jenis_cuti" id="jenis-cuti" class="select select-bordered"
                                                required>
                                                <option disabled selected>Pilih salah satu</option>
                                                @foreach ($jenis_cutis as $jenis_cuti)
                                                <option value="{{ $jenis_cuti->id }}">{{ $jenis_cuti->nama_cuti }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-control mb-4">
                                            ...
                                            <textarea name="alasan" id="alasan" class="textarea textarea-bordered h-24"
                                                required placeholder="Bio"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-4 gap-4">
                                        ...
                                        <div class="form-control mb-4">
                                            ...
                                            <input type="number" placeholder="Selama" id="selama" name="selama" required
                                        ...
                                        <div class="form-control mb-4">
                                            ...
                                            <input type="date" placeholder="Mulai tanggal" id="mulai" name="mulai"
                                        ...
                                        <div class="form-control mb-4">
                                            ...
                                            <input type="date" placeholder="Sampai dengan" id="sampai" name="sampai"
                                                required class="input input-bordered w-full">
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div class="form-control mb-4">
                                            ...
                                            <textarea name="alamat" id="alamat" class="textarea textarea-bordered h-24"
                                                required placeholder="Bio"></textarea>
                                        </div>
                                        ...
                                        <div class="form-control mb-4">
                                            ...
                                            <input type="text" placeholder="No. Telp" id="telp" name="telp"
                                                class="input input-bordered w-full" required maxlength="13"
                                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="p-6 mb-4 bg-gray-50 rounded-lg">
                                ...
                                <div class="">
                                    <input type="file" name="file_upload[]" id="file-upload" data-max-file-size="5MB"
                                        data-max-files="5" accept="image/png, image/jpeg, application/pdf" multiple>
                                </div>
